...
test("UPDATE_SUCCESS_MESSAGE tells the user to restart Aegis Agent", () => {
  assert.equal(UPDATE_SUCCESS_MESSAGE, "🎉 Update ran successfully! Please restart Aegis Agent.");
});
